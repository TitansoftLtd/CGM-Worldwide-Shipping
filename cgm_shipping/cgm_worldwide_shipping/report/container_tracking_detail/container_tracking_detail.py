...
def get_columns():
	return [
		...
		{"fieldname": "shipping_line", "label": _("Shipping Line"), "fieldtype": "Link", "options": "Supplier", "width": 120},
		{"fieldname": "rate_source", "label": _("Rate Source"), "fieldtype": "Data", "width": 140},
