...
CONTAINER_UPDATE_TASK_SEQS = frozenset({11, 17, 19, 20, 21, 22, 23, 24, 25})
CONTAINER_UPDATE_SEED_SEQS = frozenset({11, 17, 19, 20, 21, 22, 23, 24, 25})
TRANSPORT_TASK_SEQS = frozenset({20, 21, 22, 23, 24, 25})
