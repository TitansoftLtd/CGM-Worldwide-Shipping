"""
Sea task requirements API for CGM Shipping Settings.

This module is the canonical runtime interpreter for
`CGM Shipping Settings -> custom_sea_clearance_task_requirements`.
"""
